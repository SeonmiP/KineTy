...
import kinety.prompt_attention.ptp_utils as ptp_utils
from kinety.common.image_util import save_gif_mp4_folder_type
from kinety.prompt_attention.attention_store import AttentionStore
...
def show_cross_attention(tokenizer, prompts, attention_store: AttentionStore, 
    ...
    for j in range(attention_maps.shape[0]):
        images = []
        kinety_list = [4, 7, 9, 11, 13, 16]
        eccv_list = [4, 7, 10, 13]
        # for i in kinety_list:
        for i in eccv_list:
